...
public class RestClient {
    ...
    public static final String BASE_URL = "http://192.168.1.103/Server/";//http://<ipaddress>/directoryname
    //public static final String BASE_URL = "https://onlinemedicareshop.000webhostapp.com/";//http://<ipaddress>/directoryname
